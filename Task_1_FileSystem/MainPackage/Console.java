			...
			else if (choice == 1 )
			{
				...
				if (choice == 1 )
				{
					...
					for(Customer c: customer_list)
					{
						...
						if(c.getID() == choice )
						{
							if(c.CheckAccount(1) == true && c.CheckAccount(2) == false)
							{
				...
				{
					customer_list.add(new Customer());			// Customer is not registered call customer constructor to register and create account
					n.savetofile();
